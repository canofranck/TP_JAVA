...
public class Main 
{
	...
	{
		//Item 1
		TypeDonneeAnnee ttAnnee=new TypeDonneeAnnee(2);
		TypeDonneeAnnee annee2008=new TypeDonneeAnnee(2008);
		TypeDonneeAnnee annee2012 = new TypeDonneeAnnee(2012);
		TypeDonneeAnnee annee2020 = new TypeDonneeAnnee(2012);
		
	
		
	Livre livre1= new Livre("celebre auteur","le monde perdu",2,20,null,annee2008);
	
	Livre livre2= new Livre("Dorison Xavier","Goldorak",2,30,null,annee2012);
	...
	// tpobjet_02  item2 	
	Livre livre3= new Livre("auteur merveilleux","le genie",300,25,null,annee2020);
	//Livre livre4= new Livre("auteur mort ","la tombe ",100,5,null);
