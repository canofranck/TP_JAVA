...
public class TestComptable 
{
	...
	public static void main(String[] args)
	{
		...
		Livre livre3= new Livre("auteur mort ","titre fameux",200,10);
		Livre livre4= new Livre("auteur fou ","qu est ce que la folie ",999,5.50);
		...
		// item 2
		Livre livre5= new Livre("auteur incroyable ","comment devenir bon  ",1,9.50);
